...
ActiveRecord::Schema.define(version: 20160314041321) do
  ...
  create_table "listings", force: :cascade do |t|
    ...
    t.integer  "borrow_length",                  null: false
  ...
  add_index "users", ["listing_id", "created_at"], name: "index_users_on_listing_id_and_created_at", using: :btree
